...
class ResourceManager:
    ...
    def _initialize_resources(self) -> None:
        ...
        for resource_type, config in self._default_configs.items():
            # Create semaphore
            self.semaphores[resource_type] = asyncio.Semaphore(
        ...
        logger.info("Resource manager initialized",
                   resources=list(self.semaphores.keys()))
    ...
    def configure_resource(
        ...
        if rate_limit is not None:
            ...
            logger.info("Updated rate limit",
                       resource=resource_type,
    ...
    def get_stats(self, resource_type: Optional[str] = None) -> Dict[str, Any]:
        ...
        if resource_type:
            ...
            for res_type in set(
                list(self.semaphores.keys()) + 
                list(self._usage_stats.keys())
            ):
